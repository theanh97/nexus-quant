"""
Phase 313 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.31, OBJ=6.0391 (P308-P312 cycle complete)

New cycle P313-P317 after P308-P312 advanced OBJ 6.0005→6.0391. V1 internals
may have shifted after regime weights (P309).
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 313 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: v2.49.31 OBJ=6.0391 (P308-P312 cycle)")
    print("=" * 70)
    ...
    result = {
        "phase": "313", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase313"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase313_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P313 per-regime V1 weights OBJ={reported_obj:.4f} "
