"""
Phase 343 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.35, OBJ=6.2892 (P338-P342 cycle complete)

New cycle P343-P327 after P338-P342 advanced OBJ 6.2892→6.5794. V1 internals
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 343 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: v2.49.35 OBJ=6.2892 (P338-P342 cycle)")
    print("=" * 70)
    ...
    result = {
        "phase": "343", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase343"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase343_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P343 per-regime V1 weights OBJ={reported_obj:.4f} "
