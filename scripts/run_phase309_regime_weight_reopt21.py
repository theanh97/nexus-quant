"""
Phase 309 — Regime Weight Re-opt (21st Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.30, OBJ=6.0005 (after P308 V1 weights +0.0261)

After P308 V1 internal weights VALIDATED, re-sweep ensemble weights
to check if regime allocations can improve.
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 309 — Regime Weight Re-opt (21st Pass) [VECTORIZED]")
    print("After P308 V1 weights VALIDATED — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P308 V1 weights VALIDATED — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase309"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase309_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P309 regime weight reopt21 OBJ={reported_obj:.4f} "
