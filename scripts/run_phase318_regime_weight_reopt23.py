"""
Phase 318 — Regime Weight Re-opt (23rd Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.33, OBJ=6.2248 (parallel session advances)

After P315-P317 confirmed overlays/boundaries optimal,
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase318"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase318_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 318 — Regime Weight Re-opt (23rd Pass) [VECTORIZED]")
    print("After P315-P317 confirmed overlays/boundaries optimal")
    ...
    out = Path("artifacts/phase318"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase318_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P318 regime weight reopt23 OBJ={reported_obj:.4f} "
