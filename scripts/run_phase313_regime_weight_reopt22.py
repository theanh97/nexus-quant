"""
Phase 313 — Regime Weight Re-opt (22nd Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.30, OBJ=6.0005 (Phase 308 V1 weights)

After P311 (FTS confirmed) and P312 (breadth confirmed),
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase313"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase313_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 313 — Regime Weight Re-opt (22nd Pass) [VECTORIZED]")
    print("After P311 FTS + P312 breadth confirmed")
    ...
    out = Path("artifacts/phase313"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase313_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P313 regime weight reopt22 OBJ={reported_obj:.4f} "
