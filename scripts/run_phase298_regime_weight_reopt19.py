"""
Phase 298 — Regime Weight Re-opt (19th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.21, OBJ=5.6221 (Phase 295 vol+disp retune)

After P293-P295 (V1 weights, regime weights, vol+disp overlays),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 298 — Regime Weight Re-opt (19th Pass) [VECTORIZED]")
    print("After P293-P295 V1 + overlay changes")
    ...
    report = {
        ...
        "context": "After P293-P295 V1 + overlay changes",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase298"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase298_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P298 regime weight reopt19 OBJ={reported_obj:.4f} "
