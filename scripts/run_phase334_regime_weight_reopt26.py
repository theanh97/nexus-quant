"""
Phase 334 — Regime Weight Re-opt (26th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.39, OBJ=6.5794 (after P329 regime weights +0.0363)

After P333 V1 weights confirmed at exact local optimum,
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 334 — Regime Weight Re-opt (26th Pass) [VECTORIZED]")
    print("After P333 V1 weights (no change) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P333 V1 weights (no change) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase334"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase334_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P334 regime weight reopt26 OBJ={reported_obj:.4f} "
