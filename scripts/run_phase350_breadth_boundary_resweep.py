"""
Phase 350 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: v2.49.35, OBJ=6.2892 (after P319 regime weight reopt23 LOYO=5/5)

After P318 V1 weights (+0.0281) + P319 regime weights (+0.0363),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 350 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P350 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
