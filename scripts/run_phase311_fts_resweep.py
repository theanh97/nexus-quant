"""
Phase 311 — Per-Regime FTS Re-Sweep after P308-P310 [VECTORIZED]
=================================================================
Baseline: v2.49.31, OBJ=6.0391 (after P309 regime weights +0.0386)

After P308 (V1 +0.0261), P309 (regime weights +0.0386), P310 (boundary no change),
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 311 — FTS Re-Sweep after P308-P310 [VECTORIZED]")
