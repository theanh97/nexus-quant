"""
Phase 323 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.35, OBJ=6.2892 (P318-P322 cycle complete)

New cycle P323-P327 after P318-P322 advanced OBJ 6.2248→6.2892. V1 internals
may have shifted after regime weights (P319).
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 323 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: v2.49.35 OBJ=6.2892 (P318-P322 cycle)")
    print("=" * 70)
    ...
    result = {
        "phase": "323", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase323"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase323_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P323 per-regime V1 weights OBJ={reported_obj:.4f} "
