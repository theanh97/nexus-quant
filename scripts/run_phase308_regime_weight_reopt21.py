"""
Phase 308 — Regime Weight Re-opt (21st Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.28, OBJ=5.9612 (Phase 304 regime weight reopt)

After P304-P307 (vol/disp overlays, FTS, breadth all confirmed),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 308 — Regime Weight Re-opt (21st Pass) [VECTORIZED]")
    print("After P304-P307 overlay + boundary changes")
    ...
    report = {
        ...
        "context": "After P304-P307 overlay + boundary changes",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase308"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase308_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P308 regime weight reopt21 OBJ={reported_obj:.4f} "
