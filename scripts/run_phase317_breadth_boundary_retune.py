"""
Phase 317 — Breadth Boundary Re-Tune (p_low / p_high)
=======================================================
Baseline: v2.49.32, OBJ=6.1979 (P314 V1 weight resweep)

After P314 changed LOW V1 weights, re-sweep breadth regime boundaries.
Current: p_low=0.30, p_high=0.60 (confirmed 5x in P275, P302, P307, P312, P316).
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 317 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if delta < MIN_DELTA:
        ...
        result = {
            "phase": "317", "baseline_obj": float(obj_base), "stored_baseline": base_obj,
    ...
    if validated:
        ...
        msg = (f"feat: P317 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
