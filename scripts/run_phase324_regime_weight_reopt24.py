"""
Phase 324 — Regime Weight Re-opt (24th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.35, OBJ=6.2892 (after P319 regime weights +0.0363)

After P323 V1 weights confirmed at exact local optimum,
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 324 — Regime Weight Re-opt (24th Pass) [VECTORIZED]")
    print("After P323 V1 weights (no change) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P323 V1 weights (no change) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase324"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase324_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P324 regime weight reopt24 OBJ={reported_obj:.4f} "
