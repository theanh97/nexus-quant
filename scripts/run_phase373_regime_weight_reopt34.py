"""
Phase 373 — Regime Weight Re-opt (31st Pass) [VECTORIZED]
=========================================================
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 373 — Regime Weight Re-opt (31st Pass) [VECTORIZED]")
    ...
    out = Path("artifacts/phase373"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase373_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P373 regime weight reopt24 OBJ={reported_obj:.4f} "
