"""
Phase 398 — Regime Weight Re-opt (31st Pass) [VECTORIZED]
=========================================================
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase398"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase398_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 398 — Regime Weight Re-opt (31st Pass) [VECTORIZED]")
    ...
    out = Path("artifacts/phase398"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase398_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P398 regime weight reopt24 OBJ={reported_obj:.4f} "
