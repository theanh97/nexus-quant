"""
Phase 316 — Per-Regime FTS Re-Sweep after P313-P315 [VECTORIZED]
=================================================================
Baseline: v2.49.33, OBJ=6.2248 (after P314 regime weights +0.0269)

After P313 (V1 no change), P314 (regime weights +0.0269), P315 (boundary no change),
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 316 — FTS Re-Sweep after P313-P315 [VECTORIZED]")
