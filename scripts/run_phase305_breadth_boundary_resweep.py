"""
Phase 305 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: v2.49.28, OBJ=5.9612 (after P304 regime weight reopt20)

After P303 V1 weights (no change) + P304 regime weights (+0.0260),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 305 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P305 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
