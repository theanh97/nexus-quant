"""
Phase 385 — Per-Regime Vol + Disp Overlay Re-Tune [VECTORIZED]
================================================================
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase385"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase385_report.json").write_text(json.dumps(_partial, indent=2))
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 385 — Vol + Disp Overlay Re-Tune [VECTORIZED]")
    print("=" * 70)
    ...
    out = Path("artifacts/phase385"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase385_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P385 vol+disp retune OBJ={reported_obj:.4f} "
