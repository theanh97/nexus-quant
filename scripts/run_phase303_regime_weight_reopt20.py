"""
Phase 303 — Regime Weight Re-opt (20th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.25, OBJ=5.8110 (Phase 300 vol+disp retune)

After P298-P300 (V1 weights, regime weights, vol+disp overlays),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 303 — Regime Weight Re-opt (20th Pass) [VECTORIZED]")
    print("After P298-P300 V1 + overlay changes")
    ...
    report = {
        ...
        "context": "After P298-P300 V1 + overlay changes",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase303"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase303_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P303 regime weight reopt20 OBJ={reported_obj:.4f} "
