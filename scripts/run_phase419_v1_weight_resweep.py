"""
Phase 419 — Per-Regime V1 Internal Weight Re-Sweep [VECTORIZED]
================================================================
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase419"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase419_report.json").write_text(json.dumps(_partial, indent=2))
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 419 — Per-Regime V1 Internal Weight Re-Sweep")
    print("=" * 70)
    ...
    out = Path("artifacts/phase419"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase419_report.json").write_text(json.dumps(result, indent=2))
    print(f"\n  Report → artifacts/phase419/phase419_report.json")
