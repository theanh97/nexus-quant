#!/usr/bin/env python3
"""Phase 276 — HIGH Regime Re-retune Round 10. Parallel again set f168=0."""
...
def main():
    ...
    print(f"    Current HIGH: v1={base_weights['HIGH']['v1']} f168={base_weights['HIGH']['f168']}")
    ...
    # f168 sweep (known optimal range: 0.25-0.40)
    print("\n[3] f168 sweep ...")
    ...
    # v1 sweep (known optimal range: 0.18-0.22)
    print("\n[4] v1 sweep ...")
    best_v1 = base_weights["HIGH"]["v1"]
    ...
    print("\n[5] idio_ratio sweep ...")
    best_ratio = iratio
    for ratio in [0.20, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70, 0.80]:
    ...
    if wins >= 3 and delta > 0.005:
        ...
        msg = f"quant: {new_ver} — HIGH retune r10 (v1={bh['v1']:.2f} f168={bh['f168']:.2f}) OBJ={best_obj:.4f}"
    ...
    print(f"\n[DONE] Phase 276 complete.  ({elapsed:.1f}s)")
