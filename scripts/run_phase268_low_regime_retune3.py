#!/usr/bin/env python3
"""
Phase 268 — LOW Regime Re-retune Round 3
After P267: HIGH now has f168=0.35/i415=0.315, MID=pure f168
Current LOW: v1=0.35, i460=0.20, i415=0.00, f168=0.45
Sweep: A) f168, B) v1, C) i460/i415 split
"""
...
def make_low_w(base_weights, f168_w, v1_w, i415_frac):
    ...
    return {"LOW": {"v1": v1_w, "i460": i460_w, "i415": i415_w, "f168": f168_w},
            "MID": base_weights["MID"], "HIGH": base_weights["HIGH"]}

def main():
    t0 = time.time()
    print("=" * 60)
    print("Phase 268 — LOW Regime Re-retune Round 3")
    print("After P267: HIGH f168=0.35, MID=f168=1.00")
    print("=" * 60)
    ...
    curr_i415_frac = curr_low["i415"] / curr_rem if curr_rem > 0 else 0.0

    # [2] f168 sweep
    print("\n[2] f168 sweep ...")
    f168_cands = [0.00, 0.10, 0.20, 0.30, 0.40, 0.45, 0.50, 0.60, 0.70, 0.80, 0.90, 1.00]
    ...
    # [3] v1 sweep
    print("\n[3] v1 sweep ...")
    v1_cands = [0.00, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50]
    ...
    frac_cands = [0.00, 0.10, 0.20, 0.30, 0.40, 0.50, 0.60, 0.70, 0.80, 0.90, 1.00]
    ...
    print(f"  Best i415_frac: {best_frac:.2f}  D={best_frac_obj-baseline_obj:+.4f}")
