"""
Phase 294 — Regime Weight Re-opt (18th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.18, OBJ=5.5022 (Phase 293 V1 weight resweep)

After P293 changed V1 internal weights (carry/mom/mr) for all regimes,
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase294"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase294_report.json").write_text(json.dumps(_partial, indent=2))
...
def load_config_params():
    ...
    return {
        ...
        "ts_pct_win": fts.get("per_regime_ts_pct_win", {"LOW": 240, "MID": 294, "HIGH": 400}),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 294 — Regime Weight Re-opt (18th Pass) [VECTORIZED]")
    print("After P293 V1 internal weight changes")
    ...
    report = {
        ...
        "context": "After P293 V1 internal weight changes",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase294"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase294_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P294 regime weight reopt18 OBJ={reported_obj:.4f} "
