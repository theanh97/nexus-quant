"""
Phase 338 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.35, OBJ=6.2892 (P333-P337 cycle complete)

New cycle P338-P327 after P333-P337 advanced OBJ 6.2892→6.5794. V1 internals
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 338 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: v2.49.35 OBJ=6.2892 (P333-P337 cycle)")
    print("=" * 70)
    ...
    result = {
        "phase": "338", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase338"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase338_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P338 per-regime V1 weights OBJ={reported_obj:.4f} "
