"""
Phase 307 — Breadth Boundary Re-Tune (p_low / p_high)
=======================================================
Baseline: v2.49.28, OBJ=5.9612 (Phase 304 regime weight reopt)

After P304-P306 (regime weights, vol/disp overlays, FTS all changed),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 307 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P307 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
