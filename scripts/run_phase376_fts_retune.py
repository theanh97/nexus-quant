"""
Phase 376 — Per-Regime FTS Retune [VECTORIZED]
============================================================================
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase376_fts"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase376_fts_report.json").write_text(json.dumps(_partial, indent=2))
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 376 — FTS Retune [VECTORIZED]")
    print("=" * 70)
    ...
    out = Path("artifacts/phase376_fts"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase376_fts_report.json").write_text(json.dumps(result, indent=2))
    print(f"\n  Report → artifacts/phase376_fts/phase376_fts_report.json")
    ...
    if validated:
        ...
        msg = (f"feat: P376 FTS retune OBJ={reported_obj} "
