"""
Phase 364 — Per-Regime V1 Internal Weight Re-Sweep [VECTORIZED]
================================================================
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase364"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase364_report.json").write_text(json.dumps(_partial, indent=2))
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 364 — Per-Regime V1 Internal Weight Re-Sweep")
    print("=" * 70)
    ...
    out = Path("artifacts/phase364"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase364_report.json").write_text(json.dumps(result, indent=2))
    print(f"\n  Report → artifacts/phase364/phase364_report.json")
