"""
Phase 301 — Per-Regime FTS Re-Sweep after P298-P300 [VECTORIZED]
=================================================================
Baseline: v2.49.25, OBJ=5.8110 (Phase 300 boundary no change)
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 301 — FTS Re-Sweep after P298-P300 [VECTORIZED]")
