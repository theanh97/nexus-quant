"""
Phase 319 — Regime Weight Re-opt (23rd Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.34, OBJ=6.2529 (after P318 V1 weights +0.0281)

After P318 V1 weights validated (+0.0281),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 319 — Regime Weight Re-opt (23rd Pass) [VECTORIZED]")
    print("After P318 V1 weights (+0.0281) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P318 V1 weights (+0.0281) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase319"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase319_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P319 regime weight reopt23 OBJ={reported_obj:.4f} "
