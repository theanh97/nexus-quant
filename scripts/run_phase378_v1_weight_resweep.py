"""
Phase 378 — Per-Regime V1 Internal Weight Re-Sweep [VECTORIZED]
================================================================
Baseline: v2.49.40, OBJ=6.7382 (P358 regime weight reopt — no change)

V1 internal weights (carry/mom/mean_reversion) — re-sweep after
P355-P358 confirmed all other params optimal.

Current (from P358 confirmed optimal):
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 378 — Per-Regime V1 Internal Weight Re-Sweep")
    print("=" * 70)
    ...
    result = {
        "phase": "359", "title": "Per-Regime V1 Weight Re-Sweep",
    ...
    out = Path("artifacts/phase378"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase378_report.json").write_text(json.dumps(result, indent=2))
    print(f"\n  Report → artifacts/phase378/phase378_report.json")
