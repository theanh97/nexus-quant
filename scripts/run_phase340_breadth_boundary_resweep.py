"""
Phase 340 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 340 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P340 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
