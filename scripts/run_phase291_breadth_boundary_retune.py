"""
Phase 291 — Breadth Boundary Re-Tune (p_low / p_high)
=======================================================
Baseline: v2.49.15, OBJ=5.4545 (Phase 290 FTS retune, LOYO=5/5)

After P287-P290 (V1 weights, regime weights, overlays all changed),
re-sweep the breadth regime boundaries. Current: p_low=0.30, p_high=0.62.
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 291 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P291 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
