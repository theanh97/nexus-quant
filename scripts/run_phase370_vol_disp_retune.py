"""
Phase 370 — Per-Regime Vol + Disp Overlay Re-Tune [VECTORIZED]
================================================================
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 370 — Vol + Disp Overlay Re-Tune [VECTORIZED]")
    print("=" * 70)
    ...
    if validated:
        ...
        msg = (f"feat: P370 vol+disp retune OBJ={reported_obj:.4f} "
