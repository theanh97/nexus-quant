"""
Phase 343 — Regime Weight Re-opt (28th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.40, OBJ=6.7382 (P342 boundary resweep — no change)

After P340-P342 confirmed overlays/boundaries optimal,
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase343"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase343_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 343 — Regime Weight Re-opt (28th Pass) [VECTORIZED]")
    print("After P340-P342 confirmed overlays/boundaries optimal")
    ...
    out = Path("artifacts/phase343"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase343_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P343 regime weight reopt24 OBJ={reported_obj:.4f} "
