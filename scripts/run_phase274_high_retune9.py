#!/usr/bin/env python3
"""
Phase 274 — HIGH Regime Re-retune Round 9
Parallel session again set HIGH: v1=0.5, i460=0.5, f168=0.0
Re-validate f168 contribution. Sweeps f168, v1, idio_ratio.
...
def main():
    ...
    iratio = 0.40  # known good from P272
    ...
    print(f"\n[DONE] Phase 274 complete.  ({elapsed:.1f}s)")
