"""
Phase 300 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: v2.49.24, OBJ=5.7591 (Phase 299 regime weight reopt19, LOYO=5/5)

After P298 V1 weights + P299 regime weights, re-sweep the breadth regime
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 300 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P300 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
