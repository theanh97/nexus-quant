"""
Phase 342 — Breadth Boundary Re-Tune (p_low / p_high)
=======================================================
Baseline: v2.49.40, OBJ=6.7382 (P341 FTS retune — no change)

Continue R&D cycle: re-sweep breadth regime boundaries.
Current: p_low=0.30, p_high=0.60 (confirmed 10x in P275, P302, P307, P312, P317, P322, P327, P332, P337).
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 342 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if delta < MIN_DELTA:
        ...
        result = {
            "phase": "342", "baseline_obj": float(obj_base), "stored_baseline": base_obj,
    ...
    if validated:
        ...
        msg = (f"feat: P342 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
