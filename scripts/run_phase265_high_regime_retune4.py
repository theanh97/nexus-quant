#!/usr/bin/env python3
"""
Phase 265 — HIGH Regime Re-retune Round 4
Current HIGH: v1=0.35, i460=0.65, i415=0.00, f168=0.00
Notable: f168=0 and i415=0 in HIGH — verify this is truly optimal
...
def main():
    t0 = time.time()
    print("=" * 60)
    print("Phase 265 — HIGH Regime Re-retune Round 4")
    print("Current HIGH: v1=0.35, i460=0.65, i415=0.00, f168=0.00")
    print("Verifying: is f168=0 truly optimal?")
    print("=" * 60)
    ...
    curr_ratio = curr_high["i460"] / curr_idio if curr_idio > 0 else 1.0
    ...
    # [3] v1 sweep
    print("\n[3] v1 sweep ...")
    v1_candidates = [0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55]
    ...
    # [4] idio_ratio sweep
    print("\n[4] idio_ratio (i460 fraction) sweep ...")
    ratio_candidates = [0.00, 0.10, 0.20, 0.30, 0.40, 0.50, 0.60, 0.70, 0.80, 0.90, 1.00]
...
def _update_config(cfg, bw, new_obj):
    ...
    subprocess.run(["git", "commit", "-m",
        f"quant: {new_ver} — HIGH regime retune r4 (v1={bw['v1']:.2f} f168={bw['f168']:.2f}) OBJ={new_obj:.4f}"],
