"""
Phase 310 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: v2.49.31, OBJ=6.0391 (after P309 regime weight reopt21 LOYO=5/5)

After P308 V1 weights (+0.0261) + P309 regime weights (+0.0386),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 310 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P310 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
