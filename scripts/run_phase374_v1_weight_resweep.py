"""
Phase 374 — Per-Regime V1 Internal Weight Re-Sweep [VECTORIZED]
================================================================
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 374 — Per-Regime V1 Internal Weight Re-Sweep")
    print("=" * 70)
    ...
    print(f"\n  Report → artifacts/phase374/phase374_report.json")
