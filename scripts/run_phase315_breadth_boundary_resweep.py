"""
Phase 315 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: v2.49.33, OBJ=6.2248 (after P314 regime weight reopt22 LOYO=4/5)

After P313 V1 weights (no change) + P314 regime weights (+0.0269),
re-sweep breadth regime boundaries. Current: p_low=0.30, p_high=0.60.
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 315 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P315 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
