"""
Phase 351 — Per-Regime FTS Retune [VECTORIZED]
============================================================================
Baseline: v2.49.40, OBJ=6.7382 (P350 vol/disp retune — no change)

Continue R&D cycle: re-sweep FTS overlay params.

Current FTS (confirmed optimal in P296-P341, P346):
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 351 — FTS Retune [VECTORIZED]")
    print("=" * 70)
