"""
Phase 328 — Regime Weight Re-opt (25th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.36, OBJ=6.4480 (P327 boundary resweep — no change)

After P325-P327 confirmed overlays/boundaries optimal,
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase328"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase328_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 328 — Regime Weight Re-opt (25th Pass) [VECTORIZED]")
    print("After P325-P327 confirmed overlays/boundaries optimal")
    ...
    out = Path("artifacts/phase328"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase328_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P328 regime weight reopt24 OBJ={reported_obj:.4f} "
