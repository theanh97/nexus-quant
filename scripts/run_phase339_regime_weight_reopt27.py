"""
Phase 339 — Regime Weight Re-opt (27th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.42, OBJ=6.7932 (after P338 V1 weights +0.0281)

After P338 V1 weights validated (+0.0281),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 339 — Regime Weight Re-opt (27th Pass) [VECTORIZED]")
    print("After P338 V1 weights (+0.0281) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P338 V1 weights (+0.0281) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase339"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase339_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P339 regime weight reopt27 OBJ={reported_obj:.4f} "
