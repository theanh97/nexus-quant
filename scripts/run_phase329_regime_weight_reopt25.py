"""
Phase 329 — Regime Weight Re-opt (25th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.38, OBJ=6.5431 (after P328 V1 weights +0.0682)

After P328 V1 weights validated (+0.0682),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 329 — Regime Weight Re-opt (25th Pass) [VECTORIZED]")
    print("After P328 V1 weights (+0.0682) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P328 V1 weights (+0.0682) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase329"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase329_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P329 regime weight reopt25 OBJ={reported_obj:.4f} "
