"""
Phase 314 — Regime Weight Re-opt (22nd Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.31, OBJ=6.0391 (after P309 regime weights +0.0386)

After P313 V1 weights confirmed at exact local optimum,
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 314 — Regime Weight Re-opt (22nd Pass) [VECTORIZED]")
    print("After P313 V1 weights (no change) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P313 V1 weights (no change) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase314"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase314_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P314 regime weight reopt22 OBJ={reported_obj:.4f} "
