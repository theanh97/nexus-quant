"""
Phase 302 — Breadth Boundary Re-Tune (p_low / p_high)
=======================================================
Baseline: v2.49.25, OBJ=5.8110 (Phase 300 vol+disp retune)

After P298-P300 (V1 weights, regime weights, overlays all changed),
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 302 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P302 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
