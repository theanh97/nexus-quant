"""
Phase 306 — Per-Regime FTS Re-Sweep after P303-P305 [VECTORIZED]
=================================================================
Baseline: v2.49.28, OBJ=5.9612 (after P304 regime weights +0.0260)

After P303 (V1 no change), P304 (regime weights +0.0260), P305 (boundary no change),
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 306 — FTS Re-Sweep after P303-P305 [VECTORIZED]")
