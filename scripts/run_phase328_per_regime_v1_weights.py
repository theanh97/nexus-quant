"""
Phase 328 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.35, OBJ=6.2892 (P323-P327 cycle complete)

New cycle P328-P327 after P323-P327 advanced OBJ 6.2892→6.2892. V1 internals
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 328 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: v2.49.35 OBJ=6.2892 (P323-P327 cycle)")
    print("=" * 70)
    ...
    result = {
        "phase": "328", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase328"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase328_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P328 per-regime V1 weights OBJ={reported_obj:.4f} "
