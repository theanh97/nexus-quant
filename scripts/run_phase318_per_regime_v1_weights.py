"""
Phase 318 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.33, OBJ=6.2248 (P313-P317 cycle complete)

New cycle P318-P322 after P313-P317 advanced OBJ 6.1979→6.2248. V1 internals
may have shifted after regime weights (P314).
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 318 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: v2.49.33 OBJ=6.2248 (P313-P317 cycle)")
    print("=" * 70)
    ...
    result = {
        "phase": "318", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase318"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase318_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P318 per-regime V1 weights OBJ={reported_obj:.4f} "
