"""
Phase 323 — Regime Weight Re-opt (24th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.35, OBJ=6.2892 (P322 boundary resweep — no change)

After P320-P322 confirmed overlays/boundaries optimal,
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase323"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase323_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 323 — Regime Weight Re-opt (24th Pass) [VECTORIZED]")
    print("After P320-P322 confirmed overlays/boundaries optimal")
    ...
    out = Path("artifacts/phase323"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase323_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P323 regime weight reopt24 OBJ={reported_obj:.4f} "
