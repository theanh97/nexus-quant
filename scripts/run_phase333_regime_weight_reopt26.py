"""
Phase 333 — Regime Weight Re-opt (26th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.38, OBJ=6.5431 (P332 boundary resweep — no change)

After P330-P332 confirmed overlays/boundaries optimal,
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase333"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase333_report.json").write_text(json.dumps(_partial, indent=2))
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 333 — Regime Weight Re-opt (26th Pass) [VECTORIZED]")
    print("After P330-P332 confirmed overlays/boundaries optimal")
    ...
    out = Path("artifacts/phase333"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase333_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P333 regime weight reopt24 OBJ={reported_obj:.4f} "
