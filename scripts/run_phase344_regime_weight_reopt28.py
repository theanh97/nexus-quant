"""
Phase 344 — Regime Weight Re-opt (28th Pass) [VECTORIZED]
=========================================================
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 344 — Regime Weight Re-opt (28th Pass) [VECTORIZED]")
    print("After P343 V1 weights (no change) — re-sweep ensemble")
    ...
    report = {
        ...
        "context": "After P343 V1 weights (no change) — re-sweep ensemble",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase344"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase344_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P344 regime weight reopt28 OBJ={reported_obj:.4f} "
