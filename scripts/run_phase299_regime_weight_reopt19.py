"""
Phase 299 — Regime Weight Re-opt (19th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.23, OBJ=5.7195 (Phase 298 V1 weight resweep)

After P298 changed V1 internal weights (carry/mom/mr) for LOW regime,
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 299 — Regime Weight Re-opt (19th Pass) [VECTORIZED]")
    print("After P298 V1 internal weight changes")
    ...
    report = {
        ...
        "context": "After P298 V1 internal weight changes",
        "runtime_seconds": round(time.time() - t0, 1),
    }
    out = Path("artifacts/phase299"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase299_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P299 regime weight reopt19 OBJ={reported_obj:.4f} "
