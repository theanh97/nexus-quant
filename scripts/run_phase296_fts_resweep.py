"""
Phase 296 — Per-Regime FTS Re-Sweep after P293-P295 [VECTORIZED]
=================================================================
Baseline: v2.49.19, OBJ=5.5914 (Phase 294 regime weight reopt18, LOYO=5/5)

After P293 (V1 weights), P294 (regime weights), P295 (boundary no change),
...
# Current: rs=0.02 (disabled), rt=0.80/0.60/0.55, bs=3.5/1.5/2.5, bt=0.33/0.22/0.22, pw=240/294/400
...
def load_config_params():
    ...
    ts_pct_win = {r: int(fts.get("per_regime_ts_pct_win", {}).get(r, 294)) for r in RNAMES}
...
def main():
    t0 = time.time()
    print("=" * 70)
    print("Phase 296 — FTS Re-Sweep after P293-P295 [VECTORIZED]")
