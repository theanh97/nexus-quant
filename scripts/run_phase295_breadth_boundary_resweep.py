"""
Phase 295 — Breadth Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: v2.49.19, OBJ=5.5914 (Phase 294 regime weight reopt18, LOYO=5/5)

After P293 V1 weights + P294 regime weights, re-sweep the breadth regime
boundaries. Current: p_low=0.30, p_high=0.60.
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 295 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P295 breadth boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
