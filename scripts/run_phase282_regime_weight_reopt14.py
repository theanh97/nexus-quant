"""
Phase 282 — Regime Weight Re-opt (14th Pass) [VECTORIZED]
=========================================================
Baseline: v2.49.4, OBJ=4.7726
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase282"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase282_report.json").write_text(json.dumps(_partial, indent=2))
    sys.exit(0)
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 282 — Regime Weight Re-opt (14th Pass) [VECTORIZED]")
    ...
    out = Path("artifacts/phase282"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase282_report.json").write_text(json.dumps(report, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P282 regime weight reopt14 OBJ={reported_obj:.4f} "
