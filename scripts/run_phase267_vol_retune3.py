#!/usr/bin/env python3
"""
Phase 267 — Vol Overlay Retune Round 3
Not re-swept since P260 (before P261-P265 regime changes).
Sweep vol_thr, vol_scale.
"""
...
def main():
    t0 = time.time()
    print("=" * 60)
    print("Phase 267 — Vol Overlay Retune Round 3")
    ...
    # [2] vol_thr sweep
    print("\n[2] vol_thr sweep ...")
    thr_candidates = [0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80]
...
def _update_config(cfg, best_thr, best_scale, new_obj):
    ...
    subprocess.run(["git", "commit", "-m",
        f"quant: {new_ver} — vol retune r3 (thr={best_thr:.2f} scale={best_scale:.2f}) OBJ={new_obj:.4f}"],
