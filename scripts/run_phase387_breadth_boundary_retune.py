"""
Phase 387 — Breadth Boundary Re-Tune (p_low / p_high)
=======================================================
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase387"); out.mkdir(parents=True, exist_ok=True)
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 387 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P387 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
