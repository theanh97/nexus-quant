"""
Phase 275 — Regime Boundary Re-Sweep (p_low / p_high)
=======================================================
Baseline: Current config (post Phase 274)
Sweep p_low ∈ [0.15, 0.20, 0.25, 0.30, 0.35] and p_high ∈ [0.55, 0.60, 0.65, 0.70]
Evaluate all (p_low, p_high) pairs where p_high > p_low + 0.10

Phase 267 found p_high=0.60 (from 0.68) in LOYO=3/5.
Now re-sweeping with Phase 274's optimal regime weights to confirm.
"""
...
def _on_timeout(signum, frame):
    ...
    out = Path("artifacts/phase275"); out.mkdir(parents=True, exist_ok=True)
...
P_LOW_SWEEP  = [0.15, 0.20, 0.25, 0.30, 0.35]
P_HIGH_SWEEP = [0.55, 0.60, 0.65, 0.70, 0.75]
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 65)
    print("Phase 275 — Regime Boundary Re-Sweep (p_low / p_high)")
    ...
    if validated:
        ...
        msg = (f"feat: P275 boundary resweep p_low={best_plow:.2f} p_high={best_phigh:.2f} "
