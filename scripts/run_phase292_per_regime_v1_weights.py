"""
Phase 292 — Per-Regime V1 Internal Weights Re-Sweep [VECTORIZED, MEM-EFFICIENT]
================================================================================
Baseline: v2.49.11, OBJ=5.1177 (Phase 286 vol+disp resweep, LOYO=4/5)
...
if __name__ == "__main__":
    t0 = time.time()
    print("=" * 70)
    print("Phase 292 — Per-Regime V1 Weights Re-Sweep [MEM-EFFICIENT]")
    print("Baseline: P291 vol+disp (no change)")
    print("=" * 70)
    ...
    result = {
        "phase": "292", "baseline_obj": float(obj_base), "stored_baseline": float(base_obj),
    ...
    out = Path("artifacts/phase292"); out.mkdir(parents=True, exist_ok=True)
    (out / "phase292_report.json").write_text(json.dumps(result, indent=2))
    ...
    if validated:
        ...
        msg = (f"feat: P292 per-regime V1 weights OBJ={reported_obj:.4f} "
